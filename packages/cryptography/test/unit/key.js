...
const androidWalletKeyBytes = Uint8Array.from(
    Buffer.from(androidWalletPrivKey, "hex")
);
...
describe("PrivateKey", function () {
    it("toString() produces correctly encoded string", function () {
    ...
    it("publicKey is the same", function () {
        const privateKey = PrivateKey.fromBytes(privKeyBytes);
        expect(privateKey.publicKey.toBytes()).to.deep.equal(pubKeyBytes);
    });

    it("fromString returns correct value", function() {
