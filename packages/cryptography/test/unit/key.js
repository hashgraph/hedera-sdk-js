...
const mnemonicDeriveKey = "302e020100300506032b657004220420f8dcc99a1ced1cc59bc2fee161c26ca6d6af657da9aa654da724441343ecd16f"
...
describe("PrivateKey", function () {
    ...
    it("derive() produces correct value", async function () {
        ...
        const normalMnemonic = await Mnemonic.fromString(mnemonic);
        const key = await PrivateKey.fromMnemonic(normalMnemonic, "");
