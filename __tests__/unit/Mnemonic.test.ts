...
describe("Mnemonic", () => {
    ...
    it("should produce the expected legacy private key", async() => {
        ...
        const key = (await (await legacyMnemonic.toLegacyPrivateKey()).legacyDerive(0)).toString();
        expect(key.toString()).toStrictEqual(expectedLegacyKey);
    });
    ...
    it("legacy2 mnemonic should work", async () => {
        ...
        const legacyDerivedPrivateKey = await legacyPrivateKey.legacyDerive(0);

        expect(legacyDerivedPrivateKey.toString()).toStrictEqual("302e020100300506032b657004220f17441bffadd29c1483c945cd30f014b2ad0fe246e084afae158da1b996bf6d3");
