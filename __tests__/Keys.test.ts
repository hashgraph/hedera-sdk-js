...
test('decodePublicKey returns correct value', () => {
    expect(decodePublicKey(pubKeyStr)).toEqual(pubKey);
});
...
test('encodePublicKey is the reciprocal of decodePublicKey', () => {
    expect(encodePublicKey(decodePublicKey(pubKeyStr))).toEqual(pubKeyStr);
    expect(decodePublicKey(encodePublicKey(pubKey))).toEqual(pubKey);
});
