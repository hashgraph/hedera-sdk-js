...
async function main() {
    ...
    console.log("user1Key =>", user1Key.publicKey.toStringDer());
    console.log("user2Key =>", user2Key.publicKey.toStringDer());
    ...
    for (const [publicKey, signatures] of Object.entries(
        ...
        if (Array.isArray(signatures)) {
            console.log(
                signatures.map((sig) =>
                    PrivateKey.fromBytes(sig).toStringDer(),
                ),
            );
        }
