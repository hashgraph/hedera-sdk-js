...
export class Ed25519PrivateKey {
    ...
    /**
     * Recover a key from a legacy 22-word mnemonic.
     *
     * There is no corresponding `toMnemonic()` as the mnemonic cannot be recovered fro the key.
     *
     * This accepts legacy mnemonics generated by the Android and iOS wallets.
     *
     * This key will _not_ support child key derivation
     *
     * @param mnemonic
