...
export default class NewContractExecuteTransaction extends Transaction {
    /**
     * @param {object} [props]
     ...
     * @param {string | ReadonlyArray<import("@ethersproject/abi").Fragment | import("@ethersproject/abi").JsonFragment | string>} [props.abi]
     */
    constructor(props = {}) {
        super();
        ...
        if (props.abi != null) {
            this.setAbi(props.abi);
            this._interface = new Interface(props.abi);
        }
    }
     ...
     * @returns {NewContractExecuteTransaction}
     */
    static _fromProtobuf(
        ...
        return Transaction._fromProtobufTransactions(
            new NewContractExecuteTransaction({
                contractId:
    ...
    /**
     * @param {string | ReadonlyArray<import("@ethersproject/abi").Fragment | import("@ethersproject/abi").JsonFragment | string>} abi
     * @returns {this}
     */
    setAbi(abi) {
        this._abi = abi;
    ...
    /**
     * @param {string} name
     * @param {Array<any> | undefined} [params]
     * @returns {this}
     */
    callFunction(name, params) {
        const encodedFunctionData = this._interface?.encodeFunctionData(
            name,
            params
        );
        this._requireNotFrozen();
        // const encodedData = defaultAbiCoder.encode(test, params);

        // @ts-ignore
        this._functionParameters = arrayify(encodedFunctionData);
...
TRANSACTION_REGISTRY.set(
    ...
    NewContractExecuteTransaction._fromProtobuf
);
