...
describe("ManagedNodeAddress", function () {
    it("fromString", function () {
        ...
        expect(ipAddressInsecure.toString()).to.be.equal("35.237.200.180:50211");

        const urlAddress = ManagedNodeAddress.fromString("0.testnet.hedera.com:50211");
        ...
        expect(urlAddressSecure.toString()).to.be.equal("0.testnet.hedera.com:50212");
        ...
        expect(urlAddressInsecure.toString()).to.be.equal("0.testnet.hedera.com:50211");

        const mirrorNodeAddress = ManagedNodeAddress.fromString("hcs.mainnet.mirrornode.hedera.com:5600");
        expect(mirrorNodeAddress.address).to.be.equal("hcs.mainnet.mirrornode.hedera.com");
        expect(mirrorNodeAddress.port).to.be.equal(5600);
        expect(mirrorNodeAddress.toString()).to.be.equal("hcs.mainnet.mirrornode.hedera.com:5600");

        const mirrorNodeAddressSecure = mirrorNodeAddress.toSecure();
        expect(mirrorNodeAddressSecure.address).to.be.equal("hcs.mainnet.mirrornode.hedera.com");
        expect(mirrorNodeAddressSecure.port).to.be.equal(433);
        expect(mirrorNodeAddressSecure.toString()).to.be.equal("hcs.mainnet.mirrornode.hedera.com:433");

        const mirrorNodeAddressInsecure = mirrorNodeAddressSecure.toInsecure();
        expect(mirrorNodeAddressInsecure.address).to.be.equal("hcs.mainnet.mirrornode.hedera.com");
        expect(mirrorNodeAddressInsecure.port).to.be.equal(5600);
        expect(mirrorNodeAddressInsecure.toString()).to.be.equal("hcs.mainnet.mirrornode.hedera.com:5600");

        let err = false;
        try {
            ManagedNodeAddress.fromString("this is a random string with spaces:433")
        } catch {
            err = true;
        }
        ...
        err = false;
        try {
            ManagedNodeAddress.fromString("hcs.mainnet.mirrornode.hedera.com:notarealport")
        } catch {
            err = true;
        }
