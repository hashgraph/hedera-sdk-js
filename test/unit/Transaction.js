...
describe("Transaction", function () {
    ...
    it("can decode raw protobuf transaction bytes", async function() {
        const hexBytes = "";

        const transaction = Transaction.fromBytes(hex.decode(hexBytes));

        expect(new Hbar(1).negated(), transaction.hbarTransfers.get(new AccountId(476260)));
        expect(new Hbar(1), transaction.hbarTransfers.get(new AccountId(476267)));
    });
});
