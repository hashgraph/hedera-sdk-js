...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td style="text-align:left"><b>FileId.fromSolidityAddress()</b>
      </td>
      <td style="text-align:left">String</td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td style="text-align:left"><code>fromString(&lt;topic&gt;</code>
      </td>
      <td style="text-align:left">String</td>
      <td style="text-align:left">Generate topic ID from a string</td>
    </tr>
    <tr>
      <td style="text-align:left"><code>ConsensusTopicId.toString()</code>
      </td>
      <td style="text-align:left"></td>
      <td style="text-align:left">Coverts the topic ID to string</td>
    </tr>
    <tr>
      <td style="text-align:left"><code>ConsensusTopicId.toSolidityAddress()</code>
      </td>
      <td style="text-align:left"></td>
      <td style="text-align:left">Converts topic ID to solidity address</td>
    </tr>
  </tbody>
</table>### Example
...
```java
const topicId = new ConsensusTopicId(0,0,10);
